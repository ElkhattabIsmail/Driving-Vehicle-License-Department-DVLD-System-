...
namespace DVLD_BuisnessLayer
{
    public class clsDriver
    {
...

        {
            ...
            this.PersonInfo = clsPerson.FindUserPersonID(PersonID);
        ...
        public static clsDriver FindUserPersonIDByDriverID(int DriverID)
        {
        ...
        public static clsDriver FindUserPersonIDByPersonID(int PersonID)
        {
