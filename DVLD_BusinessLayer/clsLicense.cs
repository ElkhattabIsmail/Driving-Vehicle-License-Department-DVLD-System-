...
namespace DVLD_BuisnessLayer
{
    public class clsLicense
    {
...

        {
            ...
            this.LicenseClassIfo = clsLicenseClass.FindUserPersonID(this.LicenseClass);
            this.DetainedInfo= clsDetainedLicense.FindUserPersonIDByLicenseID(this.LicenseID);   
        ...
        public static clsLicense FindUserPersonID(int LicenseID)
        {
        ...
        public bool ReleaseDetainedLicense(int ReleasedByUserID,ref int ApplicationID)
        {
            ...
            Application.PaidFees = clsApplicationType.FindUserPersonID((int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicsense).Fees;
        ...
        public clsLicense RenewLicense(string Notes, int CreatedByUserID)
        {
            ...
            Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationType.FindUserPersonID((int)clsApplication.enApplicationType.RenewDrivingLicense).Fees;
        ...
        public clsLicense Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationType.FindUserPersonID(Application.ApplicationTypeID).Fees;
            Application.CreatedByUserID = CreatedByUserID;
