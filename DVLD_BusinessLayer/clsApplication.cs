...
namespace DVLD_BuisnessLayer
{
    public   class clsApplication
    {
...

        {
            ...
            this.ApplicationTypeInfo = clsApplicationType.FindUserPersonID(ApplicationTypeID);
        ...
        public  static clsApplication FindUserPersonIDBaseApplication(int ApplicationID)
        {
