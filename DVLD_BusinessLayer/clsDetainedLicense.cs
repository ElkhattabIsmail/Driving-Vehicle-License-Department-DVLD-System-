...
namespace DVLD_BuisnessLayer
{
    public class clsDetainedLicense
    {
        ...
        public static clsDetainedLicense FindUserPersonID(int DetainID)
        {
            ...
            if (clsDetainedLicenseData.GetDetainedInfoByID(DetainID,
        ...
        public static clsDetainedLicense FindUserPersonIDByLicenseID(int LicenseID)
        {
            ...
            if (clsDetainedLicenseData.GetDetainedInfoByLicenseID(LicenseID,
