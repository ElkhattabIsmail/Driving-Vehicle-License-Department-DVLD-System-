...
namespace DVLD_BuisnessLayer
{
    public class clsTestAppointment
    {
...

        {
            ...
            this.RetakeTestAppInfo = clsApplication.FindUserPersonIDBaseApplication(RetakeTestApplicationID);
            Mode = enMode.Update;
        }
        ...
        public static clsTestAppointment FindUserPersonID(int TestAppointmentID)
        {
