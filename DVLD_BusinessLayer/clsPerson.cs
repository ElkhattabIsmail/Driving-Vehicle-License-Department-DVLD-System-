...
namespace DVLD_BuisnessLayer
{
    public  class clsPerson
    {
        ...
        private clsPerson(int PersonID, string FirstName,string SecondName, string ThirdName,
            string LastName,string NationalNo, DateTime DateOfBirth,int Gender,
...

        {
            ...
            this.CountryInfo = clsCountry.FindUserPersonID(NationalityCountryID);
            Mode = enMode.Update;
        }
        ...
        public static clsPerson FindUserPersonID(int PersonID)
        {
        ...
        public static clsPerson FindUserPersonID(string NationalNo)
        {
