...
namespace DVLD_BuisnessLayer
{
    public class clsTest
    {
...

        {
            ...
            this.TestAppointmentInfo = clsTestAppointment.FindUserPersonID(TestAppointmentID);
        ...
        public static clsTest FindUserPersonID(int TestID)
        {
        ...
        public static clsTest FindUserPersonIDLastTestPerPersonAndLicenseClass
